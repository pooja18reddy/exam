...
<div class="wrapper row2">
  <nav id="mainav" class="clear"> 
    ...
    <ul class="clear">
      <li class="button"><a href="COE.php">ADD</a></li>
              <li class ="active"><a href="COE_display.php">Display</a></li>
...
<?php
 ...
 //Selecting Database
 $sql = "Select student_id,backlog from eligibility where backlog IS NOT NULL";
