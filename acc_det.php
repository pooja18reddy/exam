...
<div class="wrapper row2">
  <nav id="mainav" class="clear"> 
    ...
    <ul class="clear">
      <li class="active"><a href="acc_det.php">ADD</a></li>
              <li class ="button"><a href="acc_display.php">Display</a></li>
...
<h2 align="center"> STUDENT ACCOUNT DETAILS </h2>
<form action="" method="post">
<label>Student ID:</label><input type="text" name="student_id" required>
<label>Due:</label><input type="text" name="due" required>
 ...
 if(!empty($_POST['student_id']))
{
 ...
 if($numrows == 0)
  {
	  $sql = "INSERT IGNORE INTO eligibility(student_id,due) VALUES('$id','$due')";
...
{
    $sql = "UPDATE eligibility SET due='$due' WHERE student_id='$id'";
    if (mysqli_query($conn, $sql)) {
