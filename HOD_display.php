...
<div class="wrapper row2">
  <nav id="mainav" class="clear"> 
    ...
    <ul class="clear">
      <li class="button"><a href="sdi.php">ADD</a></li>
              <li class ="active"><a href="HOD_display.php">Display</a></li>
...
<?php
 ...
 //Selecting Database
 $sql = "Select student_id,issues from eligibility where issues IS NOT NULL";
